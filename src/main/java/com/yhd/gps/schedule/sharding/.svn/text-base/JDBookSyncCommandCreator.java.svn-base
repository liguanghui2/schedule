...
import com.yhd.gps.schedule.command.JDBookSyncMsgSendCommand;
 ...
 */
public class JDBookSyncCommandCreator implements ShardingDataExecCommandCreator {
    ...
    public ShardingDataExecCommand create(int shardingIndex, CountDownLatch finishSignal) {
        return new JDBookSyncMsgSendCommand(shardingIndex, finishSignal, bussinessType, msgSize, jdBookSyncService);
    }

...
<body>
<h3>异常促销如下，请检查</h3>
<h5>errorCode含义即"lp-"之后英文含义，error-data表示数据缺失</h5>
<table cellspacing="0" cellpadding="0" style="border-collapse:collapse;margin:.2em 0;">
	<tr style="background:#57A7BF;color:#fff;">
		...
		<th style="text-align:left;padding:.2em;border:1px solid #fff;">pmId</th>
		<th style="text-align:left;padding:.2em;border:1px solid #fff;">errorCode</th>
